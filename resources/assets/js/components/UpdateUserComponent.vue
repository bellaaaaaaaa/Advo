<template>
  <div>
    <form v-on:submit.prevent="updateUser" class="col-md-12 ">
      ...
      <div class='row col-md-12'><h4>User Badges</h4></div>
      ...
      <div class="row" style="padding: 0px 15px !important;">
        <div style="padding: 5px;" v-for="(badge) in selectedBadges" v-bind:key="badge.id">
          <span class="badge badge-secondary">{{badge.title}}<i v-on:click="unselectBadge(badge.id)" class="fa fa-close" style="color:white"></i></span> <!-- <i v-on:click="deleteUserBadge(badge.id)" class="fa fa-close" style="color:white"></i>-->
        </div>
      </div>
