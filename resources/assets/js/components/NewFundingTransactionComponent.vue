    ...
    <form v-on:submit.prevent="addFundingTransaction()">
      ...
      <div class="col-md-12 row">
        <div class="col-md-6">
          ...
          <select v-model="newFundingTransactionObject.benefactor_id" type="submit" class='form-control'>
        ...
        <div class="col-md-6">
          ...
          <select @change="onChange($event)" v-model="newFundingTransactionObject.scholar_id" type="submit" class='form-control'>
      ...
      <div class="col-md-12  row">
        <div class="col-md-6">
          ...
          <select v-model="newFundingTransactionObject.funding_target_id" type="submit" class='form-control'>
      ...
      <div class="col-md-12 row">
        <div class="col-md-6">
          ...
          <select v-model="newFundingTransactionObject.funding_package_id" type="submit" class='form-control'>
            <option v-for='fp in fundingPackages' :value='fp.id'>{{ fp.title }}</option>
          </select>
        </div>
        <div class="col-md-6">
          <label>Payment Method</label>
          <select v-model="newFundingTransactionObject.payment_method" type="submit" class='form-control'>
